...
const paddle1: Paddle = { x: 20, y: 250, width: 10, height: 100, speed: 8 };
const paddle2: Paddle = { x: 770, y: 250, width: 10, height: 100, speed: 8 };
const ball: Ball = { x: 400, y: 300, radius: 8, speedX: 5, speedY: 5 };
